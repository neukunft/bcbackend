package io.fusee.util.exposed.rest.serialization
...
class PatchableSerializer : ReferenceTypeSerializer<Patchable<*>> // since 2.9
{
    ...
    private constructor(fullType: ReferenceType, staticTyping: Boolean,
                        vts: TypeSerializer, ser: JsonSerializer<Any>) : super(fullType, staticTyping, vts, ser)

    private constructor(base: PatchableSerializer, property: BeanProperty,
