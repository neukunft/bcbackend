package io.fusee.util.exposed.rest.error.handler


import io.fusee.util.exposed.rest.error.exception.BadRequestException
import io.fusee.util.exposed.rest.error.exception.EntityNotFoundException
import mu.KLogging
